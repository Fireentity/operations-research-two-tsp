...
\subsubsection{The Instance and Solution Models}
...
typedef struct TspSolution {
    ...
    int *tour;                  // The sequence of visited nodes
    const TspInstance *instance;// Reference to the problem data
    pthread_mutex_t mutex;      // Thread-safety mechanism
} TspSolution;
    \end{minted}
    \caption{Internal definition of the TspSolution structure.}
    \label{lst:tspsolution}
\end{listing}
