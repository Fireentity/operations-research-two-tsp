...
This thesis is structured to guide from theoretical foundations to the algorithmic implementations.
...
Building on these preliminaries, we detail the core architecture of the solver, specifically the unified data structures that ensure information sharing across different modules.
