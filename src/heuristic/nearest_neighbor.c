...
//TODO far passare in input il nodo iniziale
...
void solve_with_nearest_neighbor_and_two_opt(unsigned long* tour,
                                             unsigned long starting_node,
                                             unsigned long number_of_nodes,
                                             const double* edge_cost_array,
                                             double* cost)
{
    solve_with_nearest_neighbor(tour, starting_node, number_of_nodes, edge_cost_array, cost);
